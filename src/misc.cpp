...
double distance_between_points (const std::array <double,3>& a1, const std::array <double,3>& a2, int xlen, int ylen, int zlen){

	std::array <double,3> delta = subtract_containers (a1, a2); 
